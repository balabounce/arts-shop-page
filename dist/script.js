...
/* harmony import */ var _modules_addStyles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/addStyles */ "./src/js/modules/addStyles.js");
...
/* harmony import */ var _modules_sizesImg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/sizesImg */ "./src/js/modules/sizesImg.js");
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/sliders */ "./src/js/modules/sliders.js");
...
/* harmony import */ var _modules_drop__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/drop */ "./src/js/modules/drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  document.querySelector('.fixed-gift').style.left = "".concat(+document.documentElement.clientWidth / 12, "rem");
  Object(_modules_hamburger__WEBPACK_IMPORTED_MODULE_4__["default"])('.burger', '.burger-menu');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-design', '.popup-close', '.popup-design');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-consultation', '.popup-close', '.popup-consultation');
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_5__["default"])('.fixed-gift', '.popup-close', '.popup-gift');
  Object(_modules_addStyles__WEBPACK_IMPORTED_MODULE_0__["default"])('.button-styles', '#styles .row');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_8__["default"])('.portfolio-menu', '.portfolio-block', '.active', '.portfolio-wrapper', '.portfolio-no');
  Object(_modules_sizesImg__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_1__["default"])('.accordion-heading', '.accordion-block');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_7__["default"])('.main-slider-item', 'vertical');
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_7__["default"])(".feedback-slider-item", 'horizontal', '.main-prev-btn', '.main-next-btn', '.main-slider-btn');
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_9__["default"])('.pageup');
  Object(_modules_drop__WEBPACK_IMPORTED_MODULE_10__["default"])(); // alert( 'Текущая прокрутка сверху: ' + `${document.documentElement.scrollHeight - document.documentElement.scrollTop}` + `\n Длина всей страницы ${+document.documentElement.clientHeight}` );
});
  ...
  buttons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      if (this.nextElementSibling.classList.contains('active-content')) {
        ...
        this.nextElementSibling.style.maxHeight = 0 + 'px'; // this.nextElementSibling.style.overflow = 'hidden';
      ...
      this.nextElementSibling.classList.add('active-content'); // this.nextElementSibling.style.overflow = 'visible';
...
var addStyles = function addStyles(triggerSelector, wrapper) {
  var trigger = document.querySelector(triggerSelector); // needClasses = document.querySelectorAll(oldClassesSelectors.replace(/\s/g, '')),
...
/* harmony default export */ __webpack_exports__["default"] = (addStyles);
...
var calc = function calc() {
  var sizeDoc = document.querySelector('#size'),
  ...
  var size, material, options, result;
  var promocodeStr = '';
  var statusMessage;

  var resultCreate = function resultCreate() {
    ...
    if (size && material) {
      ...
      calcForm.textContent = "".concat(_result, " \u0440\u0443\u0431");
    }
  ...
  var priceList = function priceList(elem, option) {
    var price;
    elem.children.forEach(function (e, index) {
  ...
  sizeDoc.addEventListener('change', function (event) {
    size = event.target.value;
    size = priceList(sizeDoc, size);
    resultCreate();
  });
  materialDoc.addEventListener('change', function (event) {
    material = event.target.value;
    material = priceList(materialDoc, material);
    resultCreate();
  });
  optionsDoc.addEventListener('change', function (event) {
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["postData"])('assets/question.php', formData).then(function (res) {
        console.dir(res);
      });
...
var postDataFunction = function postDataFunction(url, formData, statusMessage, statusImg, textMessage, mainform) {
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])(url, formData).then(function (res) {
    console.log(res);
    ...
    clearInputs(inputs);
    setTimeout(function () {// document.body.classList.remove('modal-open');
...
var validateMessageElem = document.createElement('div');
...
var validateName = function validateName(name) {
  var regex = /^[?!,.а-яА-ЯёЁ0-9\s]+$/g;
  return regex.test(name);
};

var validateMessage = function validateMessage(input, type) {
  var toValidate;

  if (type == 'phone') {
    toValidate = validatePhone; // console.log(toValidate(value));
  }
...
var formStatusCreate = function formStatusCreate() {
  var statusMessage = document.createElement('div');
  statusMessage.classList.add('status');
  return statusMessage;
};

var addValidateMessage = function addValidateMessage(input) {
  var validateMessageElem = document.createElement('div');
  validateMessageElem.classList.add('status-message');
...
var checkForError = function checkForError() {
  var error = false;
  var statuses = document.querySelectorAll('.status-message');
...
var destroyError = function destroyError() {
  var statuses = document.querySelectorAll('.status-message');
  statuses.forEach(function (status) {
    status.textContent = '';
  });
...
uploads.forEach(function (upload) {
  upload.addEventListener('input', function () {
    ...
    var dots;
    var arr = upload.files[0].name.split('.');
    arr[0].length > 6 ? dots = "..." : dots = '.';
    var name = arr[0].substring(0, 6) + dots + arr[1];
...
var specialForm = function specialForm(type, error) {
  destroyError();
  ...
  form.forEach(function (elem) {
    elem.addEventListener('submit', function (event) {
      ...
      if (checkForError() == false) {
        var mainform = elem.closest(content);
        var formData = new FormData(elem);
        var statusMessage = formStatusCreate();
        var api;
        ...
        if (elem.classList.contains('calc-form')) {
          if (+document.querySelector('.calc-price').textContent.replace(/\D/g, '')) {
            var res = +document.querySelector('.calc-price').textContent.replace(/\D/g, '');
    ...
    comments.forEach(function (input) {
      return input.addEventListener('input', function () {
        validateMessage(input, 'message');
      });
    });
    specialComments.forEach(function (input) {
      return input.addEventListener('input', function () {
        validateMessage(input, 'message');
      });
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var hamburger = function hamburger(burgerSelector, burgerMenuSelector) {
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: closeModal, openModal, modals, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var openModal = function openModal(modalSelector, clickOn) {
  var modal = document.querySelector(modalSelector);
  clearTimeout(modalTimerId);
  modal.style.display = 'block';
  modal.classList.remove('animated', 'fadeOutUp');
  modal.classList.add('animated', 'fadeInUp'); // modal.classList.remove('hide');

  document.body.classList.add('modal-open');
};
var modalTimerId = setTimeout(function () {
  return openModal('.popup-consultation');
}, 60000);
...
function scrollGift() {
  ...
  var openedModals = document.querySelectorAll('.clicked').length;
...
var giftOpen = function giftOpen(selector) {
  var gift = document.querySelector(selector);
  setTimeout(function () {
...
var modals = function modals(triggerSelector, exitSelector, modalSelector, clickOn) {
  ...
  if (clickOn != true) {
    trigger.forEach(function (elem) {
      return elem.addEventListener('click', function listener(event) {
  ...
  links.forEach(function (link) {
    link.addEventListener('click', function (event) {
      ...
      var heightTop = document.documentElement.scrollTop,
          //сколько проскроленно на момент килка
      hash = this.hash,
          //хеш кликнутой ссылки
      toBlock = document.querySelector(hash).getBoundingClientRect().top,
          //верхняя граница нужного элемента
      start = null;
...
var sizesImg = function sizesImg() {
  var sizes_blocks = document.querySelectorAll('.sizes-block'),
      sizes_text = document.querySelectorAll('.sizes-text');
  sizes_blocks.forEach(function (block) {
    var index = 0;
    var sizeImg;
    block.addEventListener('mousemove', function (e) {
      if (+e.target.classList.value.replace(/\D/g, '') > 0) {
        index = +e.target.classList.value.replace(/\D/g, '');
        sizeImg = document.querySelector(".size-".concat(index));
        sizeImg.style.display = 'none';
        sizes_text.forEach(function (size_text, i) {
          if (size_text.classList.contains("sizes-text-".concat(index))) {
            size_text.children.forEach(function (child) {
        ...
        setTimeout(function () {
          sizeImg.src = "assets/img/sizes-".concat(index, "-1.png");
        }, 50);
      }
    });
    block.addEventListener('mouseleave', function (e) {
      if (index != 0) {
        ...
        setTimeout(function () {
          sizeImg.src = "assets/img/sizes-".concat(index, ".png");
        }, 50);
      }
    });
  });
...
/* harmony default export */ __webpack_exports__["default"] = (sizesImg);
...
var tabs = function tabs(headerSelector, tabSelector, activeClass, contentClass, exceptionSelector) {
  var header = document.querySelector(headerSelector),
      tab = document.querySelectorAll(tabSelector),
      content = document.querySelector(contentClass),
      exception = document.querySelector(exceptionSelector);
  header.addEventListener('click', function (e) {
    header.children.forEach(function (elem) {
  ...
  var showTab = function showTab(classname) {
    content.children.forEach(function (elem) {
